...
let appLogin = (obj) => {
    ...
    let query = "select u.id,u.nome,u.apelido,u.company,u.email,count(*) as 'number_recycle' from utilizador u join historico_trabalhador ht on u.id=ht.id_utilizador_from_utilizador where email = ? and pwd = ? and tipo_from_tipo_utilizador = 2;";
